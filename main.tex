...
\AddToShipoutPictureFG*{%
  \AtPageUpperLeft{%
    ...
    \raisebox{-1.10in}{%
      \parbox{\paperwidth}{%
        \centering
        {\small\bfseries WORKING PAPER} \enspace{\small\textbar} \enspace{\small Draft: April 2026}\\[0.05em]
        {\footnotesize\itshape Accepted for presentation at the 2026 Economic Scholars Program, Federal Reserve Bank of Cleveland, April 17, 2026}\\[0.05em]
