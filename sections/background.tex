...
producing the statewide pattern we observe. Descriptive evidence suggests that the composition effect
is concentrated at metro colleges, which are generally not near state
borders.
