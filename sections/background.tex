...
producing the statewide pattern we observe. The spatial heterogeneity
analysis (Section~\ref{sec:spatial}) finds that the composition effect
is concentrated in metro colleges, which are generally not near state
borders.
