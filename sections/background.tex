...
Several other policy changes coincided with HOPE's introduction.
Tennessee's education lottery launched in 2003 and generated revenue that
funded both HOPE and Pre-K programs. The federal No Child Left Behind Act
(2002) altered K--12 accountability requirements nationwide. Neither
policy, however, would produce the specific pattern we document: a
monotonically ordered income quintile gradient at public colleges with no
effect at private institutions. A generic enrollment shock---whether
driven by K--12 quality, state finances, or demographic change---would
affect quintile shares unevenly but not produce five coefficients that
are monotonically ordered and statistically significant. The quintile
gradient is a prediction unique to the price-reduction mechanism in the
three-destination model, which makes it a discriminating test of the HOPE
