...
Tennessee is the most extreme state for both outcomes: the
bottom-quintile share effect ($+0.015$) ranks 1st of 21
(permutation $p = 0.048$), and the parental income rank effect
($-0.017$) also ranks 1st of 21 ($p = 0.048$). Both are significant
at the 5\% level. Figures~\ref{fig:perm_par_rank}
...
Tennessee is the most extreme state for both outcomes ($p = 0.048$
for both bottom-quintile share and parental income rank). Rambachan--Roth sensitivity
