...
scholarship's compositional effect into a permanent substitution effect
(progressive sorting) and a cyclical income effect (sensitivity to
economic downturns). Merging BEA county income data with the Chetty
panel, we show that tuition-scaling programs (Florida, West Virginia)
compensate the income effect---composition is stable during
downturns---while fixed-dollar programs (Tennessee, Georgia) do not.
This Slutsky-type decomposition produces a second five-for-five
monotonic quintile gradient, estimated on entirely different variation,
and identifies award structure as the key design parameter determining
