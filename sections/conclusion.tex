...
Unit-specific detrending attenuates the estimate to $+1.25$ pp
($p = 0.089$), bounding the effect between $+1.25$ and $+1.44$ pp
depending on the parallel trends assumption. Third, while the
