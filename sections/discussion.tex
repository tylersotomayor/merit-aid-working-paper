...
$+1.26$ pp for $Q_1$) but does not stabilize that shift during economic
...
0.87~pp larger than the male shift (SE $= 0.10$~pp, $p < 0.001$).
To interpret: the overall HOPE effect on $Q_1$ share is approximately
$+1.3$~pp. The gender decomposition reveals that this average masks
substantial heterogeneity---the female-specific effect is roughly
$+1.7$~pp while the male-specific effect is roughly $+0.8$~pp. Women
benefit twice as much as men, consistent with their higher eligibility
rate (40\% vs.\ 30\% clearing the 3.0 GPA threshold). The gender gap
grows over time: $+0.75$~pp in the first three post-treatment cohorts
($p < 0.001$) and $+0.98$~pp in later cohorts ($p = 0.002$).

The gender differential concentrates in the bottom-quintile share
rather than the mean parental income rank. The par\_rank gender gap is
$-0.16$~pp ($p = 0.130$), statistically indistinguishable from zero.
This pattern is consistent with the eligibility channel operating
primarily at the access margin. Low-income women newly eligible for
HOPE face the sharpest change in their effective choice set: without
HOPE, many would not attend a four-year public institution; with HOPE,
the price drops substantially. Higher-income students attend college
regardless of HOPE, so the gender-eligibility mechanism has little
traction in the middle and upper quintiles. The resulting composition
shift is concentrated in the tail of the income distribution---visible
in share measures but diluted in the mean.
