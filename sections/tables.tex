...
\item \textit{Notes:} Aggregate average treatment effect on the treated
  ...
  Treatment onset: $t^* = 1986$ (baseline specification). Under the
  preferred specification ($t^* = 1987$, drop 1980 cohort, BEA county
  income control), the ATT for bottom-quintile share is $+0.0126$
  (SE $= 0.0023$, $p < 0.001$) and for parental income rank is
  $-0.0081$ (SE $= 0.0018$, $p < 0.001$). Analytical standard errors
